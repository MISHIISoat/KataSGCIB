...
class AccountRepositoryImplTest {
    ...
    class ExistsByName {
        @Test
        void when_parser_return_empty_list_should_return_false() {
        ...
        @Test
        void when_the_given_account_name_is_not_present_to_account_list_should_return_false() {
        ...
        @Test
        void when_the_given_account_name_is_present_to_account_list_should_return_true() {
    ...
    class FindByName {
        @Test
        void when_account_list_is_empty_should_return_empty_optional() {
        ...
        @Test
        void when_account_list_no_contain_name_with_given_account_name_should_return_empty_optional() {
            when(mockAccountParser.getAllAccount()).thenReturn(List.of(new Account("username", 124.5), new Account("name", 12.5)));
        ...
        @Test
        void when_account_list_contain_name_with_given_account_name_should_return_account() {
            when(mockAccountParser.getAllAccount()).thenReturn(List.of(new Account("username", 124.5), new Account("name", 12.5)));
    ...
    class Add {
        @Test
        void when_account_list_is_empty_should_add_to_the_list() {
            when(mockAccountParser.getAllAccount()).thenReturn(List.of());
        ...
        @Test
        void when_account_list_contain_accounts_should_add_new_account_at_the_end_of_account_list() {
    ...
    class UpdateAmount {
        @Test
        void should_update_account_with_same_name_in_account_list() {
            var account1 = new Account("name", 1523D);
            var account2 = new Account("account2", 354D);
            when(mockAccountParser.getAllAccount()).thenReturn(List.of(account1, account2));
